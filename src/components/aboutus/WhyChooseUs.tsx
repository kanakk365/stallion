    ...
    <section className="py-20 bg-[#1a1a1a] text-white px-8 ">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-6 mb-6">
          <div className="relative overflow-hidden group rounded-sm h-[600px] md:h-[565px] md:col-span-2">
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="relative overflow-hidden group rounded-sm h-[300px] md:h-[270px]">
              <div className="absolute inset-0 z-0">
                <Image
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="relative overflow-hidden group rounded-sm h-[350px] md:h-[400px]">
            <div className="absolute inset-0 z-0">
              <Image
