...
export default function MoreThanGymSection() {
  return (
    <section className="py-10 bg-[#f4f4f4] px-4 md:px-8">
      <div className="container mx-auto px-2 md:px-4 py-6 md:py-10">
        <div className="relative">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-center">
            <ScrollAnimation>
              <div className="relative"> 
                {/* Improved red vertical bars positioning */}
                <div className="absolute left-0 top-0 transform -translate-y-full h-[27vh] w-10 md:w-16 hidden sm:flex space-x-1 md:space-x-2">
                  <div className="bg-[#e71b4b] w-5 md:w-10 h-full"></div>
                  <div className="bg-[#e71b4b] w-5 md:w-10 h-full"></div>
                </div>

                {/* Improved blue vertical bars positioning */}
                <div className="absolute left-0 bottom-0 transform translate-y-full h-[31vh] w-10 md:w-16 hidden sm:flex space-x-1 md:space-x-2">
